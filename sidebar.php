...
<aside id="sidebar">
    ...
    <?php if (have_posts()) : ?>
        <?php while ($query_banners->have_posts()) : $query_banners->the_post(); ?>
            <a title="<?php the_title_attribute(); ?>" href="<?php the_field('link_banner') ?>"><img src="<?php the_field('src_banner'); ?>" alt="<?php the_field('alt_banner') ?>" class="img-fluid img-thumbnail my-4 banner_img">
        <?php endwhile; ?>
